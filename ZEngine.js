...
ZEngine.Initialise = function(Config = null)
{
	...
	var LoadingInterval = setInterval(function(){
		...
		// Loading update
		ZEngine.Canvas2D.fillStyle = "#EAEAEA";
		ZEngine.Canvas2D.fillRect(0, 0, ZEngine.Canvas.offsetWidth, ZEngine.Canvas.offsetHeight);
...
ZEngine.CloneZEngineObject = function(obj) {
    var Copy = new ZEngineObject(obj.init1);    
    return Copy;
}
...
{
	var NewObject = ZEngine.CloneZEngineObject(this);
